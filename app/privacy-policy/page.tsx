      ...
      <div className="container">
        <div className="legal-content">
          ...
          <div className="legal-description">
            <h2>INTRODUCTION</h2>
            <p>
              Our mission at usaloanstoday.com (&quot;USA Loans Today&quot;) is to connect you with our marketplace of third party lenders, financial service providers, debt relief providers, aggregators, direct mail marketers, and email marketers (&quot;Service Providers&quot;).
            </p>
            <p>
            ...
            <p>
              This Privacy Policy applies to information we collect on the USA Loans Today website located at <a href="https://www.usaloanstoday.com">www.usaloanstoday.com</a>.
            </p>

            <h2>WHAT INFORMATION DO WE COLLECT AND HOW?</h2>
            <h3>Anonymous and Aggregated Web Traffic Information.</h3>
            <p>
            ...
            <h3>Personal Information (non-financial).</h3>
            <p>
              ...
              <ul>
                <li>Requests for Service: To start the process of getting connected with a Service Provider, we collect the above personal information on the Loan Request form on our home page.</li>
                <li>Other Requests: We collect information volunteered by users, including from requests via the Contact Us Form on our website. We also may collect email addresses of those who communicate with us via email.</li>
              </ul>
            </p>
            ...
            <p>
              ...
              <ul>
                <li>Directly from you. For example, when you complete online forms or use our website to utilize our services.</li>
                <li>Third Parties. For example, when we receive data from an affiliate, aggregator, publisher, marketer, lead generator, referring website or advertising campaign.</li>
              </ul>
            </p>
            <p>
            ...
            <p>
              We may also use or disclose your information where we conclude that we are required by law or have a good faith belief that access, preservation or disclosure of such information is reasonably necessary to protect the rights, property or safety of USA Loans Today, its users or the public.
            </p>
            <p>
            ...
            <p>
              We work with the following marketing partners:
              <ul>
                <li>Leap Theory</li>
              </ul>
            </p>
            ...
            <p>
              ...
              <ul>
                <li>Provide you with personalized content based on your use of our websites</li>
                <li>Enable you to more easily use our websites by remembering and using contact information and form information</li>
                <li>Evaluate, monitor and analyze the use of our websites and their traffic patterns to help improve our websites and services</li>
              </ul>
            </p>
            <p>
            ...
            <p>
              &quot;Session Replay Technology&quot; is used to memorialize website visits, including technology provided by third parties such as Jornaya&apos;s LeadiD and ActiveProspect&apos;s TrustedForm.
            </p>

            <h2>CHOICES YOU HAVE REGARDING YOUR INFORMATION</h2>
            <p>
            ...
            <p>
              We keep your information only so long as we need it to provide the service you&apos;ve requested and to fulfill the purposes described in this policy. Because people who purchase or download resources from Lending For Bad Credit are often interested in other solutions and resources, we keep your information on file to enable you to receive such resources. If you subscribe to our mailing list, we keep your contact information on file until you instruct us to remove it. If you unsubscribe from an email list or opt-out of email communications, we keep your email address on our opt-out list.
            </p>
            ...
            <p>
              ...
              <ol type="1">
                ...
                <li>Have their personal information deleted; and</li>
              ...
              <ul>
                <li>Identifiers
                  <ul>
                    ...
                    <li>Mailing address (including length at address)</li>
                    <li>Telephone number (including best time to call)</li>
                    <li>Email address</li>
                    <li>Birth month and date</li>
                    <li>Military affiliation</li>
                  ...
                  <ul>
                    ...
                    <li>Employment information
                      <ul>
                        ...
                        <li>Job title</li>
                        <li>Monthly income, pay period and paycheck type</li>
                    ...
                    <li>Financial information
                      <ul>
                        ...
                        <li>Length at bank</li>
                        <li>Loan amount</li>
                        <li>Loan purpose</li>
                        <li>Debt amounts (including mortgage debt, auto debt unsecured debt, tax debt, secured debt, student loan debt, medical debt, payday loan debt, personal loan debt)</li>
                        <li>Primary income source</li>
                ...
                <li>Commercial Information
                  <ul>
                    <li>Information about your debt history</li>
                    <li>Information about your assets</li>
                    <li>Sports betting/gambling preferences</li>
                    <li>Real estate preferences</li>
                    <li>Debt Assistance Preferences</li>
                  </ul>
                </li>
                <li>Biometric Information
                  <ul>
                    <li>Not collected</li>
                  </ul>
                </li>
                <li>Internet or Other Electronic Network Activity Information
                  <ul>
                    ...
                    <li>Referring affiliate information</li>
                    <li>Referring ad campaign</li>
                    <li>Time on site</li>
                    <li>Source URL</li>
                    <li>Redirect URL</li>
                  </ul>
                ...
                <li>Geolocation Data
                  <ul>
                    <li>Information that tells us from where you access our website</li>
                  </ul>
                </li>
                <li>Sensory Data
                  <ul>
                ...
                <li>Inferences Drawn from Other Personal Information
                  <ul>
                    <li>Your potential preferences for lending services, debt relief services, or other financial services</li>
                  </ul>
                </li>
              </ul>
            </p>
            <p>
              <i>Categories of Sources of Personal Information</i>
            </p>
            <p>
              We collect information from the following categories of sources:
              <ul>
            ...
            <p>
              <i>How We Share Your Personal Information</i>
            </p>
            <p>
            ...
            <p>
              <i>How We Use Your Information</i>
            </p>
            <p>
            ...
            <p>
              <i>How We Retain and Store Your Personal Information</i>
            </p>
            <p>
            ...
            <p>
              <i>How To Submit a Request to Know or a Request to Delete</i>
            </p>
            <p>
              To request this information please submit a verifiable consumer request to us by either:
              <ul>
                <li>Writing to us at: 5520 Glades Cut-off road #K9224, Fort Pierce, FL, 3498</li>
                <li>Emailing us at: <a href="mailto:contact@usaloanstoday.com">contact@usaloanstoday.com</a></li>
              </ul>
            </p>
            <p>
            ...
            <p>
              ...
              <ul>
                <li>Provide sufficient information that allows us to reasonably verify that you are the person about whom we collected personal information or that you are an authorized representative
                  <ul>
                    <li>If you request the categories of information we collect, we require your first and last name and your date of birth.</li>
                    <li>If you request the specific information or to have your information deleted, we require your first and last name, date of birth and at least one additional data point from the above list of identifiers.</li>
                  </ul>
                </li>
                <li>Describe your request with sufficient detail that allows us to understand, evaluate and respond to it.</li>
              </ul>
            </p>
            <p>
            ...
            <p>
              <i>How To Submit an Opt-Out Request</i>
            </p>
            <p>
              To exercise the right to opt-out, you can click the unsubscribe link provided in any of our communications.
            </p>
            <p>
              You do not need to create an account with us to exercise your opt-out rights. We will only use personal information provided in an opt-out request to review and comply with the request.
            </p>
            <p>
              <i>Timing and Fees for Requests</i>
            </p>
            <p>
            ...
            <p>
              <i>Other California Privacy Rights</i>
            </p>
            <p>
            ...
            <p>
              <i>Your Nevada Privacy Rights</i>
            </p>
            <p>
            ...
            <h2>HOW DO WE MAKE CHANGES TO THIS PRIVACY POLICY?</h2>
            <p>
            ...
            <p>
              If you have any questions about this policy or need to contact the Company to exercise your privacy right,s contact us or by mail at 12540 SW Leveton Dr, #P2150 Tualatin, OR, 97062.
            </p>
          </div>
        </div>
      </div>
